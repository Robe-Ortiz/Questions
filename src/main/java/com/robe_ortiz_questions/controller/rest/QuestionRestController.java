...
public class QuestionRestController {
	...
	@Operation(summary = "Eliminar pregunta por ID", description = "Elimina una pregunta del sistema mediante su ID.")
	@ApiResponses(value = { @ApiResponse(responseCode = "204", description = "Pregunta eliminada con éxito"),
			@ApiResponse(responseCode = "404", description = "Pregunta no encontrada", content = @Content) })
	@DeleteMapping("{id}")
